 ...
 * Description: Adds deposits to WooCommerce.
 */
...
if (wc_deposits_woocommerce_is_active()) :
    class WC_Deposits
    {
        ...
        private function __construct()
        {
            ...
            define('WC_ADVANCE_TEMPLATE_PATH', untrailingslashit(plugin_dir_path(__FILE__)) . '/templates/');
            define('WC_ADVANCE_PLUGIN_PATH', plugin_dir_path(__FILE__));
            define('WC_ADVANCE_PLUGIN_URL', untrailingslashit(plugins_url(basename(plugin_dir_path(__FILE__)), basename(__FILE__))));
            ...
            wc_register_order_type(
                ...
                array(
                    ...
                    'labels' => array(
                        ...
                        'parent' => _x('Parent Order', 'custom post type setting', 'woocommerce-deposits'),
        ...
        public function enqueue_styles()
        {
            if (!$this->is_disabled()) {
                ...
                if (is_cart() || is_checkout()) {
                    ...
                    wp_enqueue_script('wc-deposits-cart', WC_ADVANCE_PLUGIN_URL . '/assets/js/wc-deposits-cart.js', array('jquery'), false, true);
                ...
                if ($theme_name === 'Storefront') {
                    ...
                    <?php
                    $css = ob_get_clean();
                    wp_add_inline_style('toggle-switch', $css);
                }
        ...
        public function admin_includes()
        {
            ...
            if (is_plugin_active('woocommerce-pdf-invoices-packing-slips/woocommerce-pdf-invoices-packingslips.php')) {
                ...
                include('includes/compatibility/pdf-invoices/main.php');
            }
            ...
            if (is_admin()) {
                ...
                $this->admin_auto_updates = new Envato_items_Update_Client(
                    ...
                    'https://woocommerce-deposits.com/wp-json/crze_eius/v1/update/',
                    'https://woocommerce-deposits.com/wp-json/crze_eius/v1/verify-purchase/',
                    $purchase_code
                );
