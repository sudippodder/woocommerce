...
class WC_Deposits_Admin_Settings
{
    ...
    public function __construct(&$wc_deposits)
    {
        ...
        if ($hide_activation_notice === 'no' && empty($purchase_code)) {
            ...
            $notice = sprintf('<b>' . __('WooCommerce Deposits', 'woocommerce-deposits') . ':' . __('Please <a href="%s"> enter your purchase code </a> to receive automatic updates', 'woocommerce-deposits') . '</b>', admin_url('/admin.php?page=wc-settings&tab=wc-deposits&section=auto_updates'));
    ...
    public function enqueue_settings_script($hook)
    {
        ...
        if (function_exists('get_current_screen')) {
            ...
            if ($screen->id === 'woocommerce_page_wc-settings' && isset($_GET['tab']) && $_GET['tab'] === 'wc-deposits') {

                wp_enqueue_style('wp-color-picker');
                wp_enqueue_script('jquery-ui-datepicker');

                wp_enqueue_script('wc-deposits-admin-settings', WC_ADVANCE_PLUGIN_URL . '/assets/js/admin/admin-settings.js', array('jquery', 'wp-color-picker'));
...
//			'advanced' => __( 'Advanced' , 'woocommerce-deposits' ) // to be added in a future version
            ...
            <?php $general_settings = array(
                ...
                'fees_handling' => array(
                    ...
                    'options' => array(
                        ...
                        'full' => __('with second payment', 'woocommerce-deposits')
                    )
                ...
                'coupons_handling' => array(
                    ...
                    'options' => array(
                        ...
                        'split' => __('Split according to deposit amount', 'woocommerce-deposits'),
                        'second_payment' => __('Deduct from second payment', 'woocommerce-deposits')
                    ),
        ...
        <div id="display_text" class="wcdp-tab-content wrap <?php echo $class; ?>">
            ...
            ,
                ...
                'deposits_second_payment_text' => array(
                    ...
                    'type' => 'text',
                    'desc' => $text_to_replace . '<b>' . __('Second Payment', 'woocommerce-deposits') . '</b>',
                ...
                'deposits_second_payment_amount_text' => array(
                    ...
                    'type' => 'text',
                    'desc' => $text_to_replace . '<b>' . __('Second Payment Amount', 'woocommerce-deposits') . '</b>',
                ...
                'deposits_payment_status_text' => array(
                    ...
                    'type' => 'text',
                    'desc' => $text_to_replace . '<b>' . __('Payment Status', 'woocommerce-deposits') . '</b>',
                ...
                'deposits_deposit_pending_payment_text' => array(
                    ...
                    'type' => 'text',
                    'desc' => $text_to_replace . '<b>' . __('Deposit Pending Payment', 'woocommerce-deposits') . '</b>',
                ...
                'deposits_deposit_paid_text' => array(
                    ...
                    'type' => 'text',
                    'desc' => $text_to_replace . '<b>' . __('Deposit Paid', 'woocommerce-deposits') . '</b>',
                ...
                'deposits_order_fully_paid_text' => array(
                    ...
                    'type' => 'text',
                    'desc' => $text_to_replace . '<b>' . __('Order Fully Paid', 'woocommerce-deposits') . '</b>',
                ...
                'deposits_deposit_previously_paid_text' => array(
                    ...
                    'type' => 'text',
                    'desc' => $text_to_replace . '<b>' . __('Deposit Previously Paid', 'woocommerce-deposits') . '</b>',
     ...
     */
            ...
            $gateways_settings['wc_deposits_disallowed_gateways_for_second_payment'] = array(
                'name' => __('Disallowed For Second Payment', 'woocommerce-deposits'),
                'type' => 'multiselect',
                'class' => 'chosen_select',
                'options' => $gateways_array,
                'desc' => __('Disallowed For Second Payment', 'woocommerce-deposits'),
