...
if (!class_exists('Wc_Deposits_Pdf_Invoices_compatibility')) {
    class Wc_Deposits_Pdf_Invoices_compatibility
    {
        ...
        {
            if (!class_exists('WPO\WC\PDF_Invoices\Documents\WCDP_Partial_Payment_Invoice') && file_exists(WC_ADVANCE_PLUGIN_PATH . 'includes/compatibility/pdf-invoices/class-wcdp-partial-payment-invoice.php')) {
                ;
                $documents['WPO\WC\PDF_Invoices\Documents\WCDP_Partial_Payment_Invoice'] = include WC_ADVANCE_PLUGIN_PATH . 'includes/compatibility/pdf-invoices/class-wcdp-partial-payment-invoice.php';
