...
class WooCommerce_Membership_Plan
{
    ...
    public function __construct($id = null)
    {
        if ($id === null) {
            ...
            // Integration with other RightPress plugins
            add_filter('rightpress_all_user_capabilities', array($this, 'rightpress_all_user_capabilities'));
     ...
     * @return array
     */
    public function rightpress_all_user_capabilities($capabilities)
    {
        // Get list of all plan keys
        $all_plan_keys = self::get_list_of_all_plan_keys();

        // Iterate over plan keys
        foreach ($all_plan_keys as $plan_key => $plan_title) {
