        ...
        */
        ...
        if($this->service_name != 'Amazonsc' && $this->service_name != 'kelkoo' ){ ?>
            <div class="nav-wrapper">
                <nav class="nav-tab-wrapper">
                    ...
                    <span id="cpf-custom-feed" class="nav-tab" onclick="return submitForm('<?php echo $this->service_name ?>');"> Custom Product Feed </span>
                </nav>
            </div> 
            <div class="clear"></div>
        ...
        $output .= '
                    ...
                    Additional attributes can also be found below by clicking [Show] Additional Attributes.</p>
                        <label class="attributes-label"><input class="button-primary" type="button" title="Required Attributes" id="toggleRequiredAttributes" onclick="toggleRequiredAttributes(this);" value="Map Required Attributes"/></label>
            ...
            $output .= '</table>
			  ...
			  <label class="attributes-label"><input class="button-primary"  type="button" id="toggleOptionalAttributes" onclick="toggleOptionalAttributes(this);" value="Map Additional Attributes" title="Optional Attributes"/></label>
        ...
        $output .= '<div class="cpf-custom_feed_generation" id="cpf-custom_feed_generation"'."{$style_css}".'">
        ...
        $output .= '<h3 class="heading">Search Product(s):</h3>
                            <table class="form-table" >
                                <thead>
                                    ...
                                    <tr style="background-color: #F6F6F6;" valign="top">
                                        <th></th>
                                        <th class="forminp">
                                        ...
                                        <th class="forminp"><input type="search" id="cpf_keywords-filter" name="keywords_filter" placeholder="Type any Keywords" style="width:100%">
                                            <div class="cpf-suggestion-box"></div>
                                        </th>
                                        <th id="cpf_localcategory_list">
                                        </th>
                                        <th class="forminp">
									...
									<th  style="color:black;"><input name="hideoutofstock" type="checkbox" id="out_of_stock_checkbox">Hide Out Of Stock products ?
                                    </th>
    
                                        <th  style="color:black;"><input name="hideoutofstock" type="checkbox" id="out_of_stock_checkbox">Hide Out Of Stock products ?</th>
                                        <th><input class="button-primary" style="float:left;" title="This will search product list from above information you give and generate the result on search result section below." type="button" value="Search Product" id="submit_data" name="submit_data" onclick="submitForm('."'{$this->service_name}'".');"/></th>
                                    </tr>
                                </thead>
                            ...
                            <tfoot>
                             <tr style="background-color: #8A9FAF;" valign="top">
                                        <th><input type="checkbox" id="cpf_select_all_checkbox_footer" onclick="selectallfromfooter(this);"></th>
                                        <th>SKU</th>
                                        <th>Name</th>
                                        <th>Category</th>
                                        <th>Price</th>
                                ...
                                <tr>
                                  <th colspan="5" id="bulk-action" style="display:none;">
                                            <span id="cpf_bulk_action_list">
                                            <input type="search" name="categoryDisplayText" class="text_big merchant-category" id="categoryDisplayText" onkeyup="doFetchCategory_timed_custom('."'{$this->service_name}'".',this)" value="" autocomplete="off" placeholder="Start typing merchant category..." MN>
                                            <div style="color: grey;" class="categoryList"></div>
                                        </span>
                                        <span> <input type="button" id="doaction2" class="button-primary action apply_btn" value="Apply" onclick="cpf_apply_action(this)">
                                        </span>
                                  ...
                                  id="cpf_move_selected" value="Move Selected" onclick ="moveSelected(this) ;" />
                                </span>
                                </th>
                              
                                   <th id="show-more" colspan="2" style="text-align:right">
                                        ...
                                        <div id="submitpost" class="submitbox">
                                            <table class="cp-list-table widefat fixed striped cpf-results" id="sort_1">
                                                ...
                                                <tr id="cpf-no-products" valign="top">
                                                 ...
                                                 <tfoot>
                                                    <tr>
                                                        <td colspan="4" style="text-align: right;"><span class="delete-selected-products"><input class="button-primary" type="button"
...
$output .='</div>';
            ...
            if ($this->blockCategoryList)
                return '<input type = "hidden" id = "remote_category" name = "remote_category" value = "undefined" > ';
                    ...
                    return '<span class="label" > ' . $this->service_name . ' Category : </span >
                      <span ><input type = "text" name = "categoryDisplayText" class="text_big input-big" id = "categoryDisplayText"  onkeyup = "doFetchCategory_timed(\'' . $this->service_name . '\',  this.value)" value = "' . $initial_remote_category . '" autocomplete = "off" placeholder = "Start typing for a category name" /></span >
    ...
    public function mainDialog($source_feed = null , $feed_type = null)
    {
        ...
        $this->localCategoryList = '
			<input type = "text" name = "local_category_display" class="text_big input-big" id = "local_category_display"  onclick = "showLocalCategories(\'' . $this->service_name . '\')" value = "' . $initial_local_category . '" autocomplete = "off" readonly = "true" placeholder = "Click here to select your categories" />
