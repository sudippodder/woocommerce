...
class PBaseFeedDialog
{
    ...
    function attributeMappings()
    {
        ...
        */
        $active_tab = isset($_GET['tab']) ? sanitize_text_field($_GET['tab']) : "feed_by_cats";
        ?>
        ...
        <script type="text/javascript">
            ...
            jQuery("#cpf-custom-feed-form").submit(function (event) {
                ...
                var category = jQuery("#cpf_category_filter").val();
        ...
        <?php
        $output = '';
        $output .= '<div class="feeds_by_category" id="cpf_feeds_by_category">';
        $output .= '				
                ...
                <div class="meta-box-sortables ui-sortable">
                    ...
                    <table class="cpf-list-table widefat fixed striped cpf-results" id="cpf-sort" style="margin-top: -22px;">
                        ...
                        <tr id="cpf-no-results">
                            <td colspan="4" >No Products Search.</td>
                        </tr>
                        </tbody>
                        <tfoot>
                            <tr>
