...
class PGoogleFeed extends PXMLFeed
{
    ...
    function formatProduct($product)
    {
        ...
        if(empty($product->attributes['size']) && isset($product->attributes['options'])){
            $product->attributes['size'] = $product->attributes['options'];
        }
    ...
    {
        $output = '<?xml version="1.0" encoding="UTF-8" ?><rss version="2.0" xmlns:g="http://base.google.com/ns/1.0" xmlns:c="http://base.google.com/cns/1.0"><channel><title>' . $file_name . '</title>
