...
if (isset($_POST['provider'])) {
    if (sanitize_text_field($_POST['provider']) == 'amazonsc') {
        ...
        $marketplaceIdArray = array("Id" => array(wp_unslash($_POST['marketplaceid'])));
        ...
        $file = file_get_contents(sanitize_text_field($_POST['content']));
        ...
        rewind($feedHandle);
        $purge = false;
        if (sanitize_text_field($_POST['purgeremember']) == 'true'){
            $purge = true;
        }
