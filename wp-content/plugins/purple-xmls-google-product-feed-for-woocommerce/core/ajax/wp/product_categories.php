...
$sql = "SELECT taxo.term_id as id, term.name as title, taxo.count as tally ,taxo.* , term.* FROM $wpdb->term_taxonomy taxo LEFT JOIN $wpdb->terms term ON taxo.term_id = term.term_id WHERE taxo.taxonomy = 'product_cat'";
...
wp_send_json(wp_json_encode($categories),200);
