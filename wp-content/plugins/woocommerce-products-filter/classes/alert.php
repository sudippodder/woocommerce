...
class WOOF_ADV {
    ...
    public function __construct($alert_list = array()) {
        ...
        $this->notices_list = array(
            ...
            'woocommerce_bulk_editor' => 'profit-products-tables-for-woocommerce',
    ...
    public function alert_woocommerce_bulk_editor() {
        ...
        <div class="notice notice-info is-dismissible" id="woof_alert_woobe">
            <p class="plugin-card-woo-bulk-editor"<?php if ($screen->id != 'plugin-install') echo ' id="plugin-woobe"' ?>>
                Try WooCommerce Active Products Tables plugin for displaying shop products in table format: <a href="<?php echo network_admin_url('plugin-install.php?tab=plugin-information') ?>&amp;plugin=woo-bulk-editor&amp;TB_iframe=true&amp;width=600&amp;height=550" class="thickbox open-plugin-details-modal" aria-label="WOOF team recommends" data-title="WOOT">WOOT - WooCommerce Active Products Tables</a>.
                <a href="<?php echo network_admin_url('plugin-install.php?tab=plugin-information') ?>&amp;plugin=profit-products-tables-for-woocommerce&amp;TB_iframe=true&amp;width=600&amp;height=550" class="thickbox open-plugin-details-modal button" aria-label="More information about WOOBE" data-title="WOOBE" id="woof_alert_install_button_woobe">Install</a>
                <a class="install-now button" data-slug="profit-products-tables-for-woocommerce" href="<?php echo network_admin_url('update.php?action=install-plugin') ?>&amp;plugin=profit-products-tables-for-woocommerce&amp;_wpnonce=<?php echo wp_create_nonce('install-plugin-profit-products-tables-for-woocommerce') ?>" aria-label="Install WooCommerce Products Tables now" data-name="Woocommerce products tables" style="display:none">Install Now</a>
            </p>
        </div>
        <script>
