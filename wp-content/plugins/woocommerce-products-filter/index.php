...
?>
        ...
        <script type="text/javascript">
            ...
            ?>
                        woof_really_curr_tax = {
                            term_id: <?php echo intval($queried_obj->term_id) ?>,
                            taxonomy: "<?php echo $queried_obj->taxonomy ?>"
                        };
                    <?php
                    }
                    ...
                    ?>
                    woof_really_curr_tax = {
                        term_id: <?php echo intval($res->term_id) ?>,
                        taxonomy: "<?php echo $res->taxonomy ?>"
                    };
            <?php
                } else {
                    $this->set_really_current_term();
    ...
    ?>
        <script>
            ...
            <?php if (isset($request_data['really_curr_tax'])) : ?>
                ...
                ?>
                woof_really_curr_tax = {
                    term_id: <?php echo intval($tmp[0]) ?>,
                    taxonomy: "<?php echo WOOF_HELPER::escape($tmp[1]) ?>"
                };
            <?php endif; ?>
    ...
    public function wp_footer()
    {
        ...
        <style type="text/css">
            ...
            <?php endif; ?><?php endif; ?><?php if (!current_user_can('create_users')) : ?>.woof_edit_view {
                display: none;
            }
    ...
    public function woof_products($atts, $is_prediction = false)
    {
        ...
        if (
            $this->get_option('listen_catalog_visibility')
