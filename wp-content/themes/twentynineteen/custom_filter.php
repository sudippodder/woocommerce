 ...
 */
class CUSTOM_Widget_Layered_Nav extends CUSTOM_Widget
{
    ...
    public function __construct()
    {
        ...
        $this->widget_id          = 'custom_woocommerce_layered_nav';
        $this->widget_name        = __('Custom Filter Products by Attribute', 'woocommerce');
        parent::__construct();
    }
...
function custom_filter_register_widgets()
{

    register_widget('CUSTOM_Widget_Layered_Nav');
}
add_action('widgets_init', 'custom_filter_register_widgets');
