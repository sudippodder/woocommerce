...
<?php
	...
	add_action('wp_footer', 'test_popup');

	function test_popup()
	{
?>
	<div style="display: none;">
		<div id="inline1" style="width:450px;height:250px;overflow:auto;">
...
<?php
	...
	{
		if (!wp_next_scheduled('cron_action_work')) {
			wp_schedule_event(time(), 'cron_daily', 'cron_action_work');
		}
	}

	function db_crontest_check()
	{
		/*function works here*/
		//cron_function_here();
		write_txt_file('', 'update--> ' . date('Y-m-d'));
		/*function works here*/
	}
	add_action('cron_action_work', 'db_crontest_check');

	function cron_delete()
	{

		wp_clear_scheduled_hook('cron_action_work');
	}

	function db_crontest_schedules($schedules)
	{
		//86400
		// $schedules['cron_daily'] = array(
		// 	'interval' => 86400,
		// 	'display'  => 'Once Daily',
		// );
		$schedules['cron_ten_second'] = array(
			'interval' => 10,
			'display'  => 'Once Daily',
		);
		return $schedules;
