...
add_filter('woocommerce_my_account_my_orders_actions','update_cancel_button_on_customer_order',10,2);
function update_cancel_button_on_customer_order($action,$order){
	unset($action['cancel']);
